...
namespace LightRunners.Gameplay
{
    ...
    public class LocalBeaconDriver : MonoBehaviour
    {
        ...
        private void SpawnIfNeeded()
        {
            ...
            try { go.tag = LumenGate.RunnerTag; } catch { /* tag not in TagManager; SetupValidator should pin this */ }
            ...
            bodyCollider.radius = 1.5f; // generous so a fast-moving runner still overlaps a gate trigger
